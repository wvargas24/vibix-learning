...
(function () {
    ...
    const recorderBox = document.querySelector('.recording-box');
    const elapsedTimeTag = document.querySelector('.js-time');
    ...
    const playButtonIcon = document.querySelector('.js-play .bi'); // Constants
    ...
    const requestMicrophoneAccess = () => {
        if (navigator.mediaDevices) {
            navigator.mediaDevices.getUserMedia({
                ...
                setMessage('Something went wrong requesting the userMedia. <br/>Please make sure you are viewing this demo over https.');
            });
        } else {
